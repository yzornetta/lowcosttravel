			...
			<div class="container">
				<div class="row">
					<div class="col">
						...
						<br>
						<br>
						<br> <span>Ciudad: ${ciudad} </span> <br> <span>Cantidad
					...
					<div class="col">
						...
						<form action="valida-reserva" method="POST" autocomplete="on"
							onsubmit="return test();">

							<div class="form-style-w3ls">
								<h5 class="mb-3">Ingresar datos de pago y contacto</h5>
								<span>Nombre</span> <input placeholder="Ingresar nombre titular"
									id="nom" name="nom" type="text" required /> <span>Apellido</span>
								<input placeholder="Ingresar apellido titular" id="ape"
									name="ape" type="text" required /> <span>Tipo de tarjeta</span>
								<select tabindex="11" id="CardType" name="CardType">
									<option value="AmEx">American Express</option>
									<option value="MasterCard">MasterCard</option>
									<option value="Visa" selected>Visa</option>
								</select> <span>Numero de tarjeta</span> <input
									placeholder="Ingresar numero de tarjeta sin guiones ni espacios"
									id="CardNumber" name="CardNumber" type="text" required /> <span>Fecha
									de vencimiento</span> <input placeholder="MM/AA" id="vencimiento"
									...
									<option value="MK">Macedonia, Ex-República Yugoslava
										de</option>
									...
									type="hidden" id="nombre" name="nombre" value="${nombre}" /> <input
									type="hidden" id="fechaIngreso" name="fechaIngreso"
									value="${fechaIngreso}" /> <input type="hidden"
									id="fechaSalida" name="fechaSalida" value="${fechaSalida}" /> <span>Email</span>
								<input placeholder="Ingresar Email" id="email" name="email"
									type="text" required /> <span>Celular</span> <input
									placeholder="Ingresar numero de celular" id="cel" name="cel"
									type="text" required />
								<button class="btn2 btn-lg btn-primary btn-block" Type="Submit">Confirmar</button>

								<span>Atención: El anfitrion puede realizar el cobro en
